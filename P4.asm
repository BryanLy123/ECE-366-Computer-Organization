...
sw_loop: #write a dense array from high to low mem addresses
sw $8, 0x2020($9)
beq $9, $0, sw_done
addi $9, $9, -4
sub $8, $0, $8
...
addi $9, $0, 0x2000 #beginning addr of dense array
addi $10, $0, 20 #num of items in the sparse array
addi $7, $0, 40 #initial sparsity
...
addi $10, $10, -1 #count of sparse array --
slt $13, $10, $0
beq $13, $0, outer_loop
